          ...
          <div className="md:w-2/3">
            ...
            <div className="space-y-8">
              ...
              <div className="text-lg text-gray-700 space-y-6">
                ...
                <p>
                  Dr. Naser al-Tamimi is the founder of MidEast Strategia, a consultancy specialising in geostrategy, energy politics, and China-Gulf relations. He also serves as a <a href="https://www.ispionline.it/en/bio/naser-al-tamimi" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Senior Associate Research Fellow at the Institute for International Political Studies (ISPI)</a> in Milan, Italy, and a Senior Associate Fellow at the Global Institute for Strategic Research (GISR) in Doha, Qatar. His research primarily focuses on the Middle East, especially the Gulf region, with a particular interest in the interplay between energy dynamics and the diplomatic relationships between GCC countries and Asia, particularly China. Al-Tamimi earned his PhD in IR from the University of Durham (UK), where <a href="https://durham-repository.worktribe.com/output/1699544/china-saudi-arabia-relations-economic-partnership-or-strategic-alliance" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">his thesis examined the bilateral ties between China and Saudi Arabia</a>.
                </p>
