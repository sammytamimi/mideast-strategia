          ...
          <div className="order-2 md:order-1 max-w-3xl">
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-700">
                Welcome to MidEast Strategia – your premier source for in-depth analysis of the Middle East's evolving strategic landscape, with a special focus on China-Gulf relations.
              </p>
